...
const LogOutToaster = () => {
  ...
  return (
    <Toast.Provider swipeDirection='right' duration={10000}>
      <Toast.Root
        className="data-[state=open]:animate-slideIn data-[state=closed]:animate-hide data-[swipe=end]:animate-swipeOut
        grid grid-cols-[auto_max-content] items-center gap-x-[15px] rounded-weak bg-white p-[15px]
